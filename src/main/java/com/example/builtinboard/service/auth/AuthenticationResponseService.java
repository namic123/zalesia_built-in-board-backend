...
public class AuthenticationResponseService {
    ...
    public void createAuthenticationResponse(HttpServletResponse response, Authentication authentication, String username, String OAuthAccessToken) throws IOException {
        ...
        if(OAuthAccessToken != null){
            response.addCookie(createCookie("_OAuth2", OAuthAccessToken));
        }
    }
